...
import 'package:supply_trucks/Assistant/requestAssistant.dart';
...
import 'package:supply_trucks/Models/directDetails.dart';
...
class AssistantMethods
{
  ...
  static sendNotificationToDriver(String token, context, String ride_request_id) async
  {
    ...
    Map notificationMap = {
      'body': 'PickUp Address, ${destination.placeName}',
